...
export const UI_COPY = {
  ru: {
    ...
    subscales: "Подшкалы",
    domains: "Домены",
    averageIntensity: "Средняя выраженность",
    subscalesCount: "схем",
    rawScore: "Сырой балл",
    topSchemas: "Доминирующие домены",
    topSubscales: "Наиболее выраженные схемы",
    severityLow: "Низкий",
    severityModerate: "Умеренный",
    severityHigh: "Высокий",
    severityVeryHigh: "Очень высокий",
    outOf: "из",
    percentile: "перцентиль",
    thresholdReached: "Порог достигнут",
    downloadJson: "Скачать JSON",
    importAnswersJson: "Импорт ответов JSON",
    backToList: "К списку",
  ...
  en: {
    ...
    subscalesCount: "subscales",
    rawScore: "Raw score",
    topSchemas: "Dominant domains",
    topSubscales: "Top schemas",
    severityLow: "Low",
    ...
    importAnswersJson: "Import Answers JSON",
